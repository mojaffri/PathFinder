...
- Established CI with strict lint/type checks, 221 passing unit/integration tests (including 38 embedded-Postgres integration tests), production builds, and desktop/mobile Playwright accessibility smoke coverage.
