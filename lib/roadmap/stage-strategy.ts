...
const STRATEGIES: Record<CareerStageGroup, StageStrategy> = {
  ...
  "early-undergraduate": {
    ...
    positionSummary: "Your best return now comes from building prerequisites and credible evidence before recruiting becomes compressed.",
  ...
  "graduate-school": {
    ...
    positionSummary: "Your degree is no longer enough by itself; the advantage comes from translating specialized work into evidence employers or research groups can evaluate quickly.",
  ...
  "career-change": {
    ...
    immediateFocus: "transferable-skill positioning, one target-aligned project, a low-risk bridge engagement, and relationships in the new field",
    ...
    competitiveEdge: "combine a distinctive strength from your prior career with a newly demonstrated skill in the target field",
    credentialWindowOpen: true,
  ...
  unknown: {
    ...
    immediateFocus: "one focused project, direct field research, and clarification of your education or career stage",
